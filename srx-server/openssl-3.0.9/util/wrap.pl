...
BEGIN {
    ...
    require '/home/nils/Dokumente/ASPA/NIST-BGP-SRx/srx-server/openssl-3.0.9/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/nils/Dokumente/ASPA/NIST-BGP-SRx/srx-server/openssl-3.0.9/test/fips-and-base.cnf';
    shift;
